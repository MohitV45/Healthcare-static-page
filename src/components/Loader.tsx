...
const Loader = ({ fading }: { fading: boolean }) => {
  return (
    <div className={`fixed inset-0 z-[9999] flex items-center justify-center bg-white transition-opacity duration-1000 ${fading ? 'opacity-0 pointer-events-none' : 'opacity-100'}`}>
      <StyledWrapper>
...
const StyledWrapper = styled.div`
  .loader {
    ...
    --shine-color: #1e3a8a40;
    --shadow-color: #3b82f6; /* blue-500 */
    display: flex;
    ...
    width: 7.3em;
    height: 1.5em; /* Slightly increased height for better centering */
